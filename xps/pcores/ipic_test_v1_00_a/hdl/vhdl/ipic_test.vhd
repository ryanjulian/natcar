------------------------------------------------------------------------------
-- ipic_test.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          ipic_test.vhd
-- Version:           1.00.a
-- Description:       Top level design, instantiates library components and user logic.
-- Date:              Wed Oct 28 10:52:26 2009 (by Create and Import Peripheral Wizard)
...
--use ipic_test_v1_00_a.user_logic;
...
end entity ipic_test;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of ipic_test is
...
--  signal ipif_Bus2IP_CS                 : std_logic_vector(0 to ((IPIF_ARD_ADDR_RANGE_ARRAY'length)/2)-1);
  ...
  signal ipif_Bus2IP_CS_internal          : std_logic_vector(0 to 0);
...
begin
  ...
  PLBV46_SLAVE_SINGLE_I : entity plbv46_slave_single_v1_01_a.plbv46_slave_single
    ...
    (
      ...
      Bus2IP_BE                      => ipif_Bus2IP_BE(0 to 3),
      Bus2IP_CS                     => ipif_Bus2IP_CS_internal ,
  ...
  ------------------------------------------
  -- USER_LOGIC_I : entity ipic_test_v1_00_a.user_logic
    -- generic map
    -- (
...
--  ipif_IP2Bus_Error <= user_IP2Bus_Error;
     ...
     ipif_Bus2IP_CS<=ipif_Bus2IP_CS_internal(0) ;
end IMP;
